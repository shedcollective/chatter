				        		...
				        		<a class="discussion_list" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
					        		<div class="chatter_avatar">
					        			...
					        			@else
					        				...
					        				<span class="chatter_avatar_circle" style="background-color:#<?= \ShedCollective\Chatter\Helpers\ChatterHelper::stringToColorCode($discussion->user->{Config::get('chatter.user.database_field_with_user_name')}) ?>">
...
<script src="{{ url('/vendor/shedcollective/chatter/assets/vendor/spectrum/spectrum.js') }}"></script>
